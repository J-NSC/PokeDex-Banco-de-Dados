...
namespace Pokedex.Migrations
{
    ...
    [Migration("20230122231317_AddTipo")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pokedex.Domain.pokemon.TipoPokemon", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Pokedex.Domain.pokemon.Pokemon", b =>
                {
                    ...
                    b.HasOne("Pokedex.Domain.pokemon.TipoPokemon", "TipoPokemon")
                        .WithMany("Pokemon")
                        .HasForeignKey("TipoPokemonid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Pokedex.Domain.pokemon.Tipo", b =>
                {
                    b.HasOne("Pokedex.Domain.pokemon.TipoPokemon", null)
                        .WithMany("Tipo")
                        .HasForeignKey("TipoPokemonid");
                });
