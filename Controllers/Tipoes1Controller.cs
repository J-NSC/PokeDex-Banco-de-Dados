...
{
    public class Tipoes1Controller : Controller
    {
        private readonly ApplicationContextDb _context;

        public Tipoes1Controller(ApplicationContextDb context)
        {
            _context = context;
        }
